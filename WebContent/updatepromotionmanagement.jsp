...
<%
	...
	promotion.setEmployeeId(employeeId);
	promotion.setFromDepartmentId(fromDepartmentId);
	promotion.setToDepartmentId(toDepartmentId);
	promotion.setPromotionDetail(promotionDetail);
	promotion.setPromotionDate(promotionDate);
	promotion.setJobId(jobId);
	promotion.setModifiedBy(modifiedBy);
	promotion.setModificationDate(modificationDate);
...
%>
<p class="msg done">Promotion Management Updated Successfully!</p>