					...
					<td colspan="2">
						<table border="" width="100%" style="border: 1px solid #2779aa" rules="all">
							<tr style="background:#eeeeee">
								<td colspan="2">						
										<table border="" width="100%" id="dependentsGrid" style="border: 0px solid #2779aa" rules="all">
											<thead>								
											<tr>								
				...
				<tr style="background:#eee">
					<td colspan="2">
						<table border="" width="100%" style="border: 1px solid #2779aa" rules="all">
							<tr style="background:#eeeeee">
								<td colspan="2">	
										<table border="" width="100%" id="educationalGrid"  style="border: 0px solid #2779aa" rules="all">
											<thead>								
											<tr>								
				...
				<tr style="background:#eee">
					<td colspan="2">
						<table border="" width="100%" style="border: 1px solid #2779aa" rules="all">
							<tr style="background:#eeeeee">
								<td colspan="2">										
										<table border="" width="100%" id="schoolsGrid" style="border: 0px solid #2779aa" rules="all">
											<thead>								
											<tr>								
												<th style="background:#cccccc;color:black;">NAME. PLACE AND COUNTRY</th>
					...
					<td colspan="2">
						<table border="" width="100%" style="border: 1px solid #2779aa" rules="all">
							<tr style="background:#eee">
								...
								<td>
									<%=nationalEmployeeType.getEmploymentType() %>									
								</td>
							</tr>
						</table>
					</td>
						...
						<div id="contractTypeDiv">
							<table border="" width="100%" style="border: 1px solid #2779aa" rules="all">
								<tr style="background:#eee">
									...
									%>
									<td>
										<%=nationalEmployeeWorkPosition.getWorkPosition() %>										
									</td>
								</tr>
							</table>
						</div>
