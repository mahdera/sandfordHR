...
<%
	...
	out.print("<caption>List of Education level</caption>");
	...
	while(educationLevelItr.hasNext()){
		...
		if(ctr % 2 == 0)
			...
			out.print("<td>");
			%>
				<a href="#.jsp" onclick="deleteThisEducationLevel(<%=educationLevel.getId()%>);"><img src="design/delete.png" align="absmiddle" border="0"/></a>
			<%
			out.print("</td>");
		out.print("</tr>");
		ctr++;
