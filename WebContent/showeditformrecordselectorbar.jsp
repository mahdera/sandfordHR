	...
	$(document).ready(function(){
		$('#slctformtype').change(function(){
			...
			if(formType == "Clearance for Admin Staff"){
				$('#formDetailDiv').load('showlistofclearanceforadminstaffforedit.jsp');
			}else if(formType == "Departing Employee Checkout Form"){
				$('#formDetailDiv').load('showlistofdepartingemployeecheckoutformforedit.jsp');
			}else if(formType == "Medical Examination Form"){
				$('#formDetailDiv').load('showlistofmedicalexaminationformforedit.jsp');
			}else if(formType == "Resignation Letter Form"){
				$('#formDetailDiv').load('showlistofresignationletterformforedit.jsp');
			}else{
				$('#formDetailDiv').html('');
			}
		});
