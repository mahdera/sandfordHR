...
<%
	...
	Employee employee = new Employee(familyName,firstName,middleName,maidenName,dateOfBirth,
			...
			beenArrested,"International",false,modifiedBy,modificationDate,employeeIdNumber);
	employee.save();
	...
	EmployeeType employeeTypeObj = new EmployeeType(fetchedEmployee.getId(),employeeType,modifiedBy,modificationDate);
	employeeTypeObj.save();
	
	if(employeeType.equalsIgnoreCase("regular contract holder")){
		EmployeeContractType employeeContractType = new EmployeeContractType(fetchedEmployee.getId(),
				contractType,modifiedBy,modificationDate);
	...
	out.print("International Employee Registered Successfully!");
%>