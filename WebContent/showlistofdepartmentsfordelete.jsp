...
<%
	...
	out.print("<caption>List of Departments For Delete</caption>");
	...
	out.print("<td>");
%>
				<a href="#.jsp" onclick="deleteThisDepartment(<%=department.getId() %>);"><img src="design/delete.png" align="absmiddle" border="0"/></a>
			<%
		out.print("</td>");
		out.print("</tr>");
		ctr++;
