	...
	$(document).ready(function(){
		$('#slctformtype').change(function(){
			...
			if(formType == "Clearance for Admin Staff"){
				$('#formDetailDiv').load('showlistofclearanceforadminstafffordelete.jsp');
			}else if(formType == "Departing Employee Checkout Form"){
				$('#formDetailDiv').load('showlistofdepartingemployeecheckoutformfordelete.jsp');
			}else if(formType == "Medical Examination Form"){
				$('#formDetailDiv').load('showlistofmedicalexaminationformfordelete.jsp');
