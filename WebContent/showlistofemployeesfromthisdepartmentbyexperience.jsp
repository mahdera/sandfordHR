...
List<Employee> employeeList = Employee.getAllEmployeesOfDepartmentWithTheirAges(departmentId);
...
while(employeeItr.hasNext()){
	...
	if(ctr % 2 == 0){
		...
		out.print("</td>");
		out.print("<td>");
			out.print((Employee.getExperienceOfThisEmployee(e.getId())/365)+" years");
		out.print("</td>");
		out.print("<td>");
		%>
