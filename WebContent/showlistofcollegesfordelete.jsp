...
<%
	...
	out.print("<caption>List of Colleges for delete</caption>");
	out.print("<th>Ser.No</th>");
	out.print("<th>College Code</th>");
	out.print("<th>College Name</th>");
	out.print("<th>College Location</th>");
	...
	out.print("<td>");
%>
					<a href="#.jsp" onclick="deleteThisCollege(<%=college.getId() %>);"><img src="design/delete.png" align="absmiddle" border="0"/></a>
				<%
			out.print("</td>");
		out.print("</tr>");
		ctr++;
