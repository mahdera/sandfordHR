		...
		<%
			...
			while(clearanceFormItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showDetailsOfThisClearanceForm(<%=cleranceForm.getId() %>);">View More</a>
						|
...
<script type="text/javascript">
	function showDetailsOfThisClearanceForm(clearanceFormId){
		var divId = "clearanceDetailDiv" + clearanceFormId;
		$('#'+divId).load('showdetailsofthisclearanceform.jsp?clearanceFormId='+clearanceFormId);
	}
