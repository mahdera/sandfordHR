		...
		<%
			...
			while(medicalExaminationFormItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showDetailsOfThisMedicalExaminationForm(<%=medicalExaminationForm.getId() %>);">View More</a>
						|
...
<script type="text/javascript">
	function showDetailsOfThisMedicalExaminationForm(medicalExaminationFormId){
		var divId = "medicalExaminationFormDetailDiv" + medicalExaminationFormId;
		$('#'+divId).load('showdetailsofthismedicalexaminationform.jsp?medicalExaminationFormId='+medicalExaminationFormId);
	}
