	...
	<table border="1" width="100%">
		...
		<tr style="background:#eeeeee">
			<td>
				<table border="1" width="100%">					
					<tr>
						<td>Position Title//የሥራ ምድብ:</td>
						<td><input type="text" name="txtpositiontitle" id="txtpositiontitle" value="<%=(performanceAppraisal.getPositionTitle() != null ? performanceAppraisal.getPositionTitle() : "")%>"/></td>
					</tr>
					<tr>
						<td>Employment Date/የቅጥር ዘመን:</td>
						<td>
							<input type="text" name="txtemploymentdate" id="txtemploymentdate" value="<%=(performanceAppraisal.getEmploymentDate() != null ? performanceAppraisal.getEmploymentDate() : "")%>"/>
							<img src="sample/images/cal.gif" onclick="javascript:NewCssCal('txtemploymentdate')" />
						</td>
					</tr>
					<tr>
						<td>Department/Unit/የሠራተኛው የሥራ ክፍል:</td>
						<td>
							<select name="slctdeparment" id="slctdeparment" style="width:100%">
					...
					<tr>
						...
						<td>
							<input type="text" name="txtappraisaldate" id="txtappraisaldate" value="<%=(performanceAppraisal.getAppraisalDate() != null ? performanceAppraisal.getAppraisalDate() : "") %>"/>
							<img src="sample/images/cal.gif" onclick="javascript:NewCssCal('txtappraisaldate')" />
						</td>
					</tr>
					<tr>
						<td>Period Covered/የመገምገሚያው ዘመን ክ - እስከ:</td>
						<td>
							<input type="text" name="txtperiodcovered" id="txtperiodcovered" value="<%=(performanceAppraisal.getPeriodCovered() != null ? performanceAppraisal.getPeriodCovered() : "")%>"/>
						</td>
					</tr>
					<tr>
						<td>Date of Last Appraisal/ከዚህ በፊት ለመጨረሻ ጊዜ የተገመገመበት ቀን:</td>
						<td>
							<input type="text" name="txtlastappraisaldate" id="txtlastappraisaldate" value="<%=(performanceAppraisal.getLastAppraisalDate() != null ? performanceAppraisal.getLastAppraisalDate() : "")%>"/>
							<img src="sample/images/cal.gif" onclick="javascript:NewCssCal('txtlastappraisaldate')" />
						</td>
					</tr>
				</table>
			</td>
		...
		<tr style="background:#eeeeee">
			<td>
				...
				<textarea name="textareasummaryofduties" id="textareasummaryofduties" cols="100" rows="3" style="width:100%"><%=(performanceAppraisal.getSummaryOfDuties() != null ? performanceAppraisal.getSummaryOfDuties() : "")%></textarea>
			</td>
		</tr>		
		<tr style="background:#eeeeee">
			<td>
				...
				<textarea name="textareaspecificgoalsandobjectives" id="textareaspecificgoalsandobjectives" cols="100" rows="3" style="width:100%"><%=(performanceAppraisal.getSpecificGoalsObjectives() != null ? performanceAppraisal.getSpecificGoalsObjectives() : "") %></textarea>
			</td>
		</tr>
		<tr>
				...
				<table border="0" width="100%">
					...
					<tr>
						...
						<td align="center">
							...
							%>
								<input type="radio" name="q1" id="q1na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
								<input type="radio" name="q1" id="q1na" value="N/A"/>
							<%		
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q1" id="q1unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q1" id="q1unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q1" id="q1improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q1" id="q1improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q1" id="q1satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q1" id="q1satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q1" id="q1good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q1" id="q1good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q1" id="q1verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q1" id="q1verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						<td>2</td>
						<td><strong>Quality / የሥራ ጥራት</strong><br/><i>The quality of error free work performed
						by the individual involved.</i></td>
						<td align="center">
							<%
								if(performanceAppraisal.getQuality().equalsIgnoreCase("n/a")){
							%>
									<input type="radio" name="q2" id="q2na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q2" id="q2unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q2" id="q2improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2improvement" value="Improvement"/>
							<% 
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q2" id="q2satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q2" id="q2good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q2" id="q2verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q2" id="q2verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q3" id="q3verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q3" id="q3verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q4" id="q4na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q4" id="q4unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q4" id="q4improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q4" id="q4satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							<%
								if(performanceAppraisal.getJobKnowledgeSkill().equalsIgnoreCase("good")){
							%>
									<input type="radio" name="q4" id="q4good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							<%
								if(performanceAppraisal.getJobKnowledgeSkill().equalsIgnoreCase("very good")){
							%>
									<input type="radio" name="q4" id="q4verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q4" id="q4verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q5" id="q5verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q5" id="q5verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q6" id="q6verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q6" id="q6verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q7" id="q7verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q7" id="q7verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q8" id="q8verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q8" id="q8verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q9" id="q9verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q9" id="q9verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						...
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10na" value="N/A" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10na" value="N/A"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10unsatisfactory" value="Unsatisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10unsatisfactory" value="Unsatisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10improvement" value="Improvement" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10improvement" value="Improvement"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10satisfactory" value="Satisfactory" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10satisfactory" value="Satisfactory"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10good" value="Good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10good" value="Good"/>
							<%
								}
							%>
						</td>
						<td align="center">
							...
							%>
									<input type="radio" name="q10" id="q10verygood" value="Very good" checked="checked"/>
							<%
								}else{
							%>
									<input type="radio" name="q10" id="q10verygood" value="Very good"/>
							<%
								}
							%>
						</td>
					...
					<tr>
						<td>Total Result:</td>
						<td colspan="7">
							<input type="text" name="txttotalresult" id="txttotalresult"/>
						</td>
					</tr>
					<tr>
						<td>Average:</td>
						<td colspan="7">
							<input type="text" name="txtaverage" id="txtaverage"/>
						</td>
					</tr>
					<tr>
						<td colspan="8" align="right">
							<input type="button" value="Update" class="input-submit" name="btnupdate" id="btnupdate"/>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//alert('comm ability : '+communicationAbility);
		...
		//alert(initiativeAndResourcefulness);
		...
		var disp = dependabilityVal +" "+ qualityVal +" "+ jobKnowledgeSkillVal +" "+ attendanceUseOfTimeVal +" "+
		communicationAbilityVal +" "+ policiesAndGuidelinesVal +" "+ cooperationUnderstandingVal +" "+
		responsibilityVal +" "+ behaviorAndPersonalityVal +" "+ initiativeAndResourcefulnessVal;
		//alert(disp);
		//alert(deno);
		...
		$('#btnupdate').click(function(){	
			var performanceAppraisalId = "<%=performanceAppraisalId%>";
			var positionTitle = $('#txtpositiontitle').val();
			var employmentDate = $('#txtemploymentdate').val();
			var departmentId = $('#slctdeparment').val();
			var appraisalDate = $('#txtappraisaldate').val();
			var periodCovered = $('#txtperiodcovered').val();
			var lastAppraisalDate = $('#txtlastappraisaldate').val();
			var summaryOfDuites = $('#textareasummaryofduties').val();
			var specificGoalsAndObjectives = $('#textareaspecificgoalsandobjectives').val();
			var dependability = $("input[name=q1]:checked", '#frmperformanceappraisal').val();
			var quality = $("input[name=q2]:checked", '#frmperformanceappraisal').val();
			var jobKnowledgeSkill = $("input[name=q3]:checked", '#frmperformanceappraisal').val();
			var attendanceUseOfTime = $("input[name=q4]:checked", '#frmperformanceappraisal').val();
			...
			var dataString = "performanceAppraisalId="+performanceAppraisalId+"&positionTitle="+positionTitle+"&employmentDate="+
			employmentDate+"&departmentId="+departmentId+"&appraisalDate="+appraisalDate+"&periodCovered="+
			periodCovered+"&lastAppraisalDate="+lastAppraisalDate+"&summaryOfDuites="+summaryOfDuites+
			"&specificGoalsAndObjectives="+specificGoalsAndObjectives+"&dependability="+dependability+
			"&quality="+quality+"&jobKnowledgeSkill="+jobKnowledgeSkill+"&attendanceUseOfTime="+attendanceUseOfTime+
			"&communicationAbility="+communicationAbility+"&policiesAndGuidelines="+policiesAndGuidelines+
			"&cooperationUnderstanding="+cooperationUnderstanding+"&responsibility="+responsibility+
			"&behaviorAndPersonality="+behaviorAndPersonality+"&initiativeAndResourcefulness="+initiativeAndResourcefulness;
			$.ajax({
			    url: 'updateperformanceappraisalmanagement.jsp',		
			    data: dataString,
			    type:'POST',
		...
		});//end update button click function...
