			...
			<table border="1" width="100%">
						...
						<table border="1" width="100%">
							...
							<tr style="background:#eeeeee;display:none" id="dependentsRow">
								<td colspan="2">						
										...
										<table border="1" width="100%" id="dependentsGrid" id="dependantsSection">
											<thead>								
											<tr>								
				...
				<tr style="background:#000000;color:#ffffff">
					<td colspan="2">
						...
						In the following section, you are required to fill the employement details for the national staff.						
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td colspan="2">
						<table border="1" width="100%">
							<tr style="background:#eee">
								<td width="20%"><font color="red">*</font> Employee Type By Work Position:</td>
								<td>
									<select style="width:100%" id="slctemployeeworkposition" name="slctemployeeworkposition">
										<option value="" selected="selected">--Select--</option>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#saveButton').click(function(){
			...
			var anyDependent = $("input[name=raddependents]:checked", "#personalDataForm").val();
			...
			var employeeTypeByWorkPosition = $('#slctemployeeworkposition').val();
			...
			if(familyName != "" && firstName != "" && dateOfBirth != "" && sex != "" && employeeType != "" &&
					employeeTypeByWorkPosition != "" && workUnitId != "" && jobId != ""){
				$('#loadingDiv').show();
				$.ajax({
				    url: 'savenationalemployeeregistrationform.jsp',		
				    data: stringValues,
				    type:'POST',
				    success:function(response){
				    		$('#loadingDiv').hide();
