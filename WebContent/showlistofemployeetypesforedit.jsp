...
<%
	...
	out.print("<caption>List of Employee Types for edit</caption>");
	...
	while(employeeTypeItr.hasNext()){
		...
		if(ctr % 2 == 0)
			...
			out.print("<td>");
			%>
				<a href="#.jsp" onclick="showEditFieldsOfEmployeeType(<%=empType.getId()%>);"><img src="design/edit-icon.gif" align="absmiddle" border="0"/></a>
			<%
			out.print("</td>");
		out.print("</tr>");
		ctr++;
