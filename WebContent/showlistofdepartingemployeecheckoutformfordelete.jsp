		...
		<%
			...
			while(departingEmployeeCheckoutFormItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="deleteThisDepartingEmployeeCheckoutForm(<%=departingEmployeeCheckoutForm.getId() %>);">Delete Detail</a>						
					</td>
				</tr>
				<%
...
<script type="text/javascript">
	function deleteThisDepartingEmployeeCheckoutForm(departingEmployeeCheckoutFormId){
		...
		if(window.confirm('Are you sure you want to delete this record?')){
			...
			$.ajax({
			    url: 'deletethisdepartingemployeecheckoutform.jsp',		
			    data: dataString,
			    type:'POST',
