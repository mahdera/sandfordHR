		...
		<%
			while(recruitmentRequestItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showRecruitmentRequestFormDetailForEdit(<%=recruitmentRequest.getId() %>);">Edit Detail</a> |
...
<script type="text/javascript">
	function showRecruitmentRequestFormDetailForEdit(recruitmentRequestId){
		var divId = "recruitmentRequestDetailDiv" + recruitmentRequestId;
		$('#'+divId).load('showrecruitmentrequestformdetailforedit.jsp?recruitmentRequestId='+recruitmentRequestId);
	}
