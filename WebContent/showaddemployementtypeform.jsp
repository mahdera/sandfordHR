...
<form style="background:#eeeeee">
	<table border="0" width="100%">
		<tr>
			...
			<td><input type="text" name="txtemployementtype" id="txtemployementtype"/></td>
		</tr>
		<tr>
			<td colspan="2" align="right">
				<input type="button" value="Add" class="input-submit" onclick="saveEmployementType(document.getElementById('txtemployementtype').value);"/>
