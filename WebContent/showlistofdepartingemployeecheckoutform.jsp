		...
		<%
			...
			while(departingEmployeeCheckoutFormItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showDetailsOfThisDepartingEmployeeCheckoutForm(<%=departingEmployeeCheckoutForm.getId() %>);">View More</a>
						|
...
<script type="text/javascript">
	function showDetailsOfThisDepartingEmployeeCheckoutForm(departingEmployeeCheckoutFormId){
		var divId = "departingEmployeeCheckoutFormDetailDiv" + departingEmployeeCheckoutFormId;
		$('#'+divId).load('showdetailsofthisdepartingemployeecheckoutform.jsp?departingEmployeeCheckoutFormId='+departingEmployeeCheckoutFormId);
	}
