...
<%	
	...
	out.print("<caption>List of Languages for Edit</caption>");
	...
	while(languageItr.hasNext()){
		...
		if(ctr % 2 == 0)
			...
			out.print("<td>");
			%>
				<a href="#.jsp" onclick="showEditFieldsOfLanguage(<%=lang.getId() %>);"><img src="design/edit-icon.gif" align="absmiddle" border="0"/></a>
			<%
			out.print("</td>");
		out.print("</tr>");
		ctr++;
