	...
	<%
		...
		while(employeeItr.hasNext()){
			...
			<tr>
				...
				<td>
					<a href="#.jsp" onclick="editAttendanceDetailForEmployee(<%=employee.getId() %>);">Edit Detail</a> |
...
<script type="text/javascript">
	function editAttendanceDetailForEmployee(employeeId){
		var divId = "attendanceDetailDiv" + employeeId;
		$('#'+divId).load('showattendancedetailforemployeeforedit.jsp?employeeId='+employeeId);
	}
