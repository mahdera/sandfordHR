		...
		<%
			...
			while(leaveRequestItr.hasNext()){
				...
				<tr>
					...
					<td>
						<a href="#.jsp" onclick="showDetailsOfThisLeaveRequestForEdit(<%=leaveRequest.getId() %>);">Edit Detail</a> | 
...
<script type="text/javascript">
	function showDetailsOfThisLeaveRequestForEdit(leaveRequestId){
		var divId = "leaveRequestDetailDiv" + leaveRequestId;
		$('#'+divId).load('showdetailsofleaverequestforedit.jsp?leaveRequestId='+leaveRequestId);
	}	
</script>