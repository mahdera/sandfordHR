...
<table border="1" width="100%">
	...
	%>
		<tr>
			...
			<td>
				<a href="#.jsp" onclick="showEditFieldsOfLeaveManagement(<%=leave.getId()%>);"><img src="design/edit-icon.gif" align="absmiddle" border="0"/></a>
			</td>
		</tr>
		<%
	}
...
<div id="leaveManagementEditDiv"></div>