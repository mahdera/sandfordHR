...
<table border="1" width="100%">
	<tr style="background:#eee;font-weight:bolder;">
		...
		<td>Last Name</td>
		<td>Sex</td>
		<td>Delete Attendance Detail</td>		
	</tr>
	<%
		int ctr=1;
		while(employeeItr.hasNext()){
			...
			<tr>
				...
				<td>
					<a href="#.jsp" onclick="deleteAttendanceDetailForEmployee(<%=employee.getId() %>);">Delete Detail</a> |
...
<script type="text/javascript">
	function deleteAttendanceDetailForEmployee(employeeId){
		var divId = "attendanceDetailDiv" + employeeId;
		$('#'+divId).load('showattendancedetailforemployeefordelete.jsp?employeeId='+employeeId);
	}
