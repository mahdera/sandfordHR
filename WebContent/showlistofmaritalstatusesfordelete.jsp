...
<%
	...
	out.print("<caption>List of Marital Status for delete</caption>");
	...
	while(mItr.hasNext()){
		...
		if(ctr % 2 == 0)
			...
			out.print("<td>");
			%>
				<a href="#.jsp" onclick="deleteThisMaritalStatus(<%=m.getId()%>);"><img src="design/delete.png" align="absmiddle" border="0"/></a>
			<%
			out.print("</td>");
		out.print("</tr>");
		ctr++;
